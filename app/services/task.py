...
def generate_audio(task_id, params, video_script):
    ...
    # so we perform uniform compatible reading here to avoid throwing attribute errors when calling the interface directly.
...
def start(task_id, params: VideoParams, stop_at: str = "video"):
    ...
    # Only the complete video generation pipeline needs to handle video concatenation mode;
    # this way we can avoid /subtitle and /audio requests accessing non-existent fields.
